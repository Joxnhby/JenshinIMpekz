const characters = [
    {
        ...
        photo: "/assets/character/character-monstad/venti.png",
    ...
    },
    {
        ...
        photo: "/assets/character/character-monstad/jean.png",
    ...
    },
    {
        ...
        photo: "/assets/character/character-monstad/lisa.png",
    ...
    },
    {
        ...
        photo: "/assets/character/character-monstad/kaeya.png",
    ...
    },
    {
        ...
        photo: "/assets/character/character-monstad/amber.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-liyue/zhongli.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-liyue/ningguang.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-liyue/xiao.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-liyue/ganyu.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-liyue/hutao.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-inazuma/raiden.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-inazuma/yae-miko.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-inazuma/ayato.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-inazuma/ayaka.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-inazuma/kazuha.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-sumeru/nahida.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-sumeru/tighnari.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-sumeru/nilou.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-sumeru/cyno.png",
    ...
    },
    {
        ...
        background: "/assets/character/character-sumeru/wanderer.png",
...
for(let i = 0; i < characters.length; i++){
    if(characters[i].map == "mondstadt"){
        charclass[i] = "mondstadt"
    }
    else if(characters[i].map == "liyue"){
        charclass[i] = "liyue"
    }
    else if(characters[i].map == "inazuma"){
        charclass[i] = "inazuma"
    }
    else if(characters[i].map == "sumeru"){
        charclass[i] = "sumeru"
    }
}
    ...
    map[i].addEventListener("click", (e)=>{
        ...
        for(let j = 0; j < characters.length; j++){
            if(characters[j].map == map[i].innerHTML.toLowerCase()){
                ...
                const charactersname = document.createElement("h3")
                charactersname.innerText = characters[j].name
                const charID = document.createElement("id")
                charID.id = "char" + (j+1)
                makecharacters.appendChild(charactersimage)
                makecharacters.appendChild(charactersname)
                makecharacters.appendChild(charID)
                charList.appendChild(makecharacters)
                ...
                // }
                // else{
                //     charList.childNodes[0].classList.add("character")
                // }
                for(let i = count; i < charList.childNodes.length; i++){
                    charList.childNodes[i].addEventListener("click", (e)=>{
                        character.src = characters[j].photo
